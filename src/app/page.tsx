...
export default async function Home() {
  ...
  return (
    <>
      ...
      <a
        href="https://wa.me/51944073494"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Contactar por WhatsApp"
        className="fixed z-50 flex h-14 w-14 items-center justify-center rounded-full transition-transform hover:scale-110 active:scale-95"
        style={{
          bottom: 90,
          right: 16,
          background: "linear-gradient(135deg,#25d366 0%,#128c4e 100%)",
          boxShadow: "0 8px 36px rgba(37,211,102,0.5), 0 0 0 1px rgba(37,211,102,0.25)",
        }}
      >
